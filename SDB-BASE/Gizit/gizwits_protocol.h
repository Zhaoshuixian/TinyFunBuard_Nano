...
* @{
*/
#define PRODUCT_KEY "205e58cbbf2b4fa8adfddd7d58d6d574"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "9bde2e456cda4dc0afa003aad16b5abd"
...
#define POWER_LEN                           1
#define FAN_GEAR_BYTEOFFSET                    0
#define FAN_GEAR_BITOFFSET                     1
#define FAN_GEAR_LEN                           1
#define RUN_MODE_BYTEOFFSET                    0
#define RUN_MODE_BITOFFSET                     2
#define RUN_MODE_LEN                           1
#define NETDATE_UPDATA_BYTEOFFSET                    0
#define NETDATE_UPDATA_BITOFFSET                     3
#define NETDATE_UPDATA_LEN                           1
#define CLEAR_DO_BYTEOFFSET                    0
#define CLEAR_DO_BITOFFSET                     4
#define CLEAR_DO_LEN                           1
#define ALARM_TYPE_BYTEOFFSET                    0
#define ALARM_TYPE_BITOFFSET                     5
#define ALARM_TYPE_LEN                           2
#define PM25_LEV_BYTEOFFSET                    5
#define PM25_LEV_BITOFFSET                     0
#define PM25_LEV_LEN                           2

#define ALARM_OPEN_HOUR_RATIO                         1
#define ALARM_OPEN_HOUR_ADDITION                      0
#define ALARM_OPEN_HOUR_MIN                           0
#define ALARM_OPEN_HOUR_MAX                           23
#define ALARM_OPEN_MIN_RATIO                         1
#define ALARM_OPEN_MIN_ADDITION                      0
#define ALARM_OPEN_MIN_MIN                           0
#define ALARM_OPEN_MIN_MAX                           59
#define ALARM_CLOSE_HOUR_RATIO                         1
#define ALARM_CLOSE_HOUR_ADDITION                      0
#define ALARM_CLOSE_HOUR_MIN                           0
#define ALARM_CLOSE_HOUR_MAX                           23
#define ALARM_CLOSE_MIN_RATIO                         1
#define ALARM_CLOSE_MIN_ADDITION                      0
#define ALARM_CLOSE_MIN_MIN                           0
#define ALARM_CLOSE_MIN_MAX                           59
#define DEVICE_ID_RATIO                         1
#define DEVICE_ID_ADDITION                      0
#define DEVICE_ID_MIN                           0
#define DEVICE_ID_MAX                           255
#define CLEAR_TIME_RATIO                         1
#define CLEAR_TIME_ADDITION                      0
#define CLEAR_TIME_MIN                           0
#define CLEAR_TIME_MAX                           65536
#define RS485_BAUD_RATIO                         1
#define RS485_BAUD_ADDITION                      0
#define RS485_BAUD_MIN                           0
#define RS485_BAUD_MAX                           120000
#define PM25_RATIO                         1
#define PM25_ADDITION                      0
#define PM25_MIN                           0
#define PM25_MAX                           65536
/**@} */
...
typedef enum
{
    ALARM_TYPE_VALUE0 = 0,//CANCEL
    ALARM_TYPE_VALUE1 = 1,//OPEN
    ALARM_TYPE_VALUE2 = 2,//CLOSE
    ALARM_TYPE_VALUE3 = 3,//ALL
    ALARM_TYPE_VALUE_MAX,
} ALARM_TYPE_ENUM_T;
typedef enum
{
    PM25_LEV_VALUE0 = 0,//GOOD
    PM25_LEV_VALUE1 = 1,//MILD
    PM25_LEV_VALUE2 = 2,//MODERATE
    PM25_LEV_VALUE3 = 3,//SEVERE
    PM25_LEV_VALUE_MAX,
} PM25_LEV_ENUM_T;
...
typedef enum
{
  ...
  EVENT_FAN_GEAR,
  EVENT_RUN_MODE,
  EVENT_NETDATE_UPDATA,
  EVENT_CLEAR_DO,
  EVENT_ALARM_TYPE,
  EVENT_ALARM_OPEN_HOUR,
  EVENT_ALARM_OPEN_MIN,
  EVENT_ALARM_CLOSE_HOUR,
  EVENT_ALARM_CLOSE_MIN,
...
typedef struct {
  ...
  bool valueFAN_GEAR;
  bool valueRUN_MODE;
  bool valueNETDATE_UPDATA;
  bool valueCLEAR_DO;
  uint32_t valueALARM_TYPE;
  uint32_t valueALARM_OPEN_HOUR;
  uint32_t valueALARM_OPEN_MIN;
  uint32_t valueALARM_CLOSE_HOUR;
  uint32_t valueALARM_CLOSE_MIN;
  uint32_t valuePM25_LEV;
  uint32_t valueDEVICE_ID;
  uint32_t valueCLEAR_TIME;
  uint32_t valueRS485_BAUD;
  uint32_t valuePM25;
} dataPoint_t;
...
typedef struct {
  uint8_t flagPOWER:1;
  uint8_t flagFAN_GEAR:1;
  uint8_t flagRUN_MODE:1;
  uint8_t flagNETDATE_UPDATA:1;
  uint8_t flagCLEAR_DO:1;
  uint8_t flagALARM_TYPE:1;
  uint8_t flagALARM_OPEN_HOUR:1;
  uint8_t flagALARM_OPEN_MIN:1;
  uint8_t flagALARM_CLOSE_HOUR:1;
  uint8_t flagALARM_CLOSE_MIN:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valueALARM_OPEN_HOUR;
  uint8_t valueALARM_OPEN_MIN;
  uint8_t valueALARM_CLOSE_HOUR;
  uint8_t valueALARM_CLOSE_MIN;
} attrVals_t;
