...
//液晶控制口电平操作语句宏定义
#define	OLED_CS(x)    (x==0?GPIO_ResetBits(OLED_PORT,OLED_CS_PIN):GPIO_SetBits(OLED_PORT,OLED_CS_PIN)) 
#define	OLED_A0(x)    (x==0?GPIO_ResetBits(OLED_PORT,OLED_A0_PIN):GPIO_SetBits(OLED_PORT,OLED_A0_PIN)) 
#define	OLED_SCL(x)   (x==0?GPIO_ResetBits(OLED_PORT,OLED_SCL_PIN):GPIO_SetBits(OLED_PORT,OLED_SCL_PIN)) 
#define	OLED_SDA(x)   (x==0?GPIO_ResetBits(OLED_PORT,OLED_SDA_PIN):GPIO_SetBits(OLED_PORT,OLED_SDA_PIN)) 
